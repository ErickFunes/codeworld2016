...
if(isset($_POST['url']) && $_POST['url'] == ''){
  ...
  Phone: $_POST[phone]";
	...
	mail($youremail, 'Visitation Request For After School Program', $body, $headers );
  ...
  <div class="row">
      ...
      <div class="row">
         ...
         <div class="col-sm-5 map-content">
                                ...
                                <div class="col-sm-5 text-center">
                        <div class="gmap">
                            <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3157.258175227196!2d-122.46084888468478!3d37.69013537977495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808f7c059c3a1543%3A0xab3ef1a44f2f8c8d!2sThomas+R+Pollicita+Middle+School!5e0!3m2!1sen!2sus!4v1456342892132"></iframe>
                        </div>
                    </div>      
        </div>
        <div class="row">
          <div class="col-xs-12 col-md-offset-1" style="text-align:left;">
            <h2>Summer Program</h2>
                <i class="fa fa-calendar fontup"></i><span class="fontup">  Start: June 13, 2016 - August 03, 2016</span> 
                <br>
                <i class="fa fa-clock-o fontup"></i><span class="fontup">  Monday - Wednesday 12:00P.M. - 3:00P.M.</span>
                <br>
                <p class="fontup">Front - End Web Development:101</p>
        ...
        <div id="sec4">
          ...
          <p>
            See if this program is a best fit for your child. Meet the Code World team and speak to an instructor, get an overview of the program curriculum, and learn about the benefits your child recieves being a student at Code World.</p>
            <div class="pfblock-line"></div>
              <form method="post" action="visitAfterSchool.php">
                <h3>After - School Program</h3>
                <i class="fa fa-globe" style="font-size:3em;"></i>
                <h3>333 Gellert Blvd. Suite #230 Daly City, CA</h3>
                <hr>
